...
table(blocking.data$condition, blocking.data$blocking.presence)
table(blocking.data$condition, blocking.data$non.off.manipulation.presence)
table(blocking.data$condition, blocking.data$dom.beh.presence)
```
